...
from model.utils.net_utils import save_net, load_net
...
class detector():
  ...
  def __init__(self):
    ...
    self.args.cfg_file = 'cfgs/vgg16-vrd.yml'
    self.args.net = 'vgg16'
    self.args.load_dir = 'models/vgg16/vrd/faster_rcnn_1_20_7559.pth'
    self.args.cuda = True
    ...
    with open('data/vrd/objects.json') as f:
      self.vrd_classes = json.load(f) # [ x.strip() for x in f.readlines() ]
