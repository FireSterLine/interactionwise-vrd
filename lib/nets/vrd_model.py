...
# ROIPool Layer from Faster-RCNN
...
class vrd_model(nn.Module):
    def __init__(self, args, bn=False):
        ...
        # self.roi_pool = RoIPool(7, 7, 1.0/16) # TODO: fix
        self.roi_pool = RoIPool(7, 1.0/16) # TODO: check if dropping the 7 was the correct choice for mantaining correctness
